module: errors
rcs-header: $Header: /scm/cvs/src/mindy/dbmc/errors.dylan,v 1.1 2003/02/28 04:46:20 housel Exp $
copyright: see below
...
define method compiler-warning-location
 ...
 => ();
  signal(make(<compiler-warning>,
	      ...
	      format-string: concatenate("Warning: ", format-string),
...
define function compiler-error-location
 ...
 => ();
  signal(make(<compiler-error>,
	      ...
	      format-string: concatenate("Error: ", format-string),
	      format-arguments: format-arguments));
end function;
