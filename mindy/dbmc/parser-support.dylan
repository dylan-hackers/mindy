module: parser
rcs-header: $Header: /scm/cvs/src/mindy/dbmc/parser-support.dylan,v 1.1 2003/02/28 04:46:20 housel Exp $
copyright: see below
...
define method process-top-level-form (form :: <constituent-parse>) => ();
  compiler-fatal-error-location(form, "don't know how to process this tlf\n");
end method;
