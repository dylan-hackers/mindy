module: tokens
rcs-header: $Header: /scm/cvs/src/mindy/dbmc/tokens.dylan,v 1.1 2003/02/28 04:46:20 housel Exp $
copyright: see below
...
define sealed method print-object
  ...
  format(stream, "{instance of <token>, kind: %=}", token.token-kind);
...
define constant $operator-info :: <object-table>
  = begin
...
define class <word-info> (<object>)
  ...
  constant slot word-info-token-kind :: <integer>,
    required-init-keyword: kind:;
  //
  // table mapping additional categories to the <word-info>
