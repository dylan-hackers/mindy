...
MACRO(INSTALL_DYLAN_LIBRARY library_name)
  INSTALL(FILES ${DYLAN_${library_name}_OUTPUT} DESTINATION ${MINDY_LIB_DIR})
ENDMACRO()
...
MACRO(INSTALL_DYLAN_TOOL tool_name)
  INSTALL(FILES ${DYLAN_${tool_name}_OUTPUT} DESTINATION bin)
ENDMACRO()
