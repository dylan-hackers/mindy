...
rcs-header: $Header: /scm/cvs/src/d2c/compiler/fer-transform/Attic/abstract-optimizer.dylan,v 1.1 2000/06/11 21:20:36 emk Exp $
copyright: See below.
...
// the optimizer.
//
define abstract primary class <abstract-optimizer> (<object>)
...
// the code.
//
define function maybe-dump-fer
    (optimizer :: <abstract-optimizer>,
     component :: <component>)
 => ()
