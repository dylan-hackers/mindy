module: main
rcs-header: $Header: /scm/cvs/src/d2c/compiler/main/main.dylan,v 1.66 2002/08/21 14:18:14 bruce Exp $
copyright: see below
...
define method show-copyright(stream :: <stream>) => ()
  ...
  format(stream, "Copyright 1998-2002 Gwydion Dylan Maintainers\n");
