...
define method GC-debug-malloc
 ...
 => (result :: <GC-PTR>);
  let result-value
    = call-out("GC_debug_malloc", ptr:, unsigned-int: arg1, ptr: (arg2).raw-value, int: arg3);
  let result-value = make(<GC-PTR>, pointer: result-value);
  values(result-value);
...
define method GC-debug-malloc-atomic
 ...
 => (result :: <GC-PTR>);
  let result-value
    = call-out("GC_debug_malloc_atomic", ptr:, unsigned-int: arg1, ptr: (arg2).raw-value, int: arg3);
  let result-value = make(<GC-PTR>, pointer: result-value);
  values(result-value);
...
define method GC-debug-malloc-uncollectable
 ...
 => (result :: <GC-PTR>);
  let result-value
    = call-out("GC_debug_malloc_uncollectable", ptr:, unsigned-int: arg1, ptr: (arg2).raw-value, int: arg3);
  let result-value = make(<GC-PTR>, pointer: result-value);
  values(result-value);
...
define method GC-debug-malloc-stubborn
 ...
 => (result :: <GC-PTR>);
  let result-value
    = call-out("GC_debug_malloc_stubborn", ptr:, unsigned-int: arg1, ptr: (arg2).raw-value, int: arg3);
  let result-value = make(<GC-PTR>, pointer: result-value);
  values(result-value);
...
define method GC-debug-realloc
 ...
 => (result :: <GC-PTR>);
  let result-value
    = call-out("GC_debug_realloc", ptr:, ptr: (arg1).raw-value, unsigned-int: arg2, ptr: (arg3).raw-value, int: arg4);
  let result-value = make(<GC-PTR>, pointer: result-value);
  values(result-value);
