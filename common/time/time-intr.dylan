...
copyright: See below.
rcs-header: $Header: /home/housel/work/rcs/gd/src/common/time/time-intr.dylan,v 1.2 1996/07/29 18:39:23 dwatson Exp $
...
define constant anonymous-29 = find-c-function("strptime");
define method string-parse-time
    (arg1 :: <byte-string>, arg2 :: <byte-string>)
 => (arg3 :: <decoded-time>);
  let arg3-ptr = make(<tm>);
  anonymous-29(export-value(<c-string>, arg1), export-value(<c-string>, arg2), arg3-ptr);
...
define method strftime
 ...
 => (result :: <size-t>);
  let result-value
    = anonymous-30(export-value(<c-string>, arg1), arg2, export-value(<c-string>, arg3), export-value(<tm>, arg4));
  values(result-value);
end method strftime;

define constant anonymous-31 = find-c-pointer("daylight");
