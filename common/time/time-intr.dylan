...
copyright: See below.
rcs-header: $Header: /scm/cvs/src/common/time/Attic/time-intr.dylan,v 1.4 2000/10/22 21:08:24 dauclair Exp $
...
define constant anonymous-30 = 
	  ...
	  method() error("Cygnus does not implement daylight") end;
#else
...
define sealed method daylight () => (result :: <integer>);
#if (compiled-for-cygnus)
  error("Cygnus does not implement daylight");
  0;
#else
